...
let dbWavelet = Array(createWaveletFromCoefficients(db2, levels: 6).dropLast())
QuickArrayPlot(array: dbWavelet)

let dbReverse = Array(createWaveletFromCoefficients(db2.reversed(), levels: 6).dropLast())
...
p0p.plotView.writeAsPdfTo(path: "/Users/vincentherrmann/Documents/Projekte/Wavelets/db2WaveletF0.pdf")

let p1p = QuickLinesPlot(x: xArray, y: r1, bounds: CGRect(x: 0, y: -3, width: viewLength, height: 4))
p1p.plotView.writeAsPdfTo(path: "/Users/vincentherrmann/Documents/Projekte/Wavelets/db2WaveletF1.pdf")

let p2p = QuickLinesPlot(x: xArray, y: r2, bounds: CGRect(x: 0, y: -3, width: viewLength, height: 4))
p2p.plotView.writeAsPdfTo(path: "/Users/vincentherrmann/Documents/Projekte/Wavelets/db2WaveletF2.pdf")

let p3p = QuickLinesPlot(x: xArray, y: r3, bounds: CGRect(x: 0, y: -3, width: viewLength, height: 4))
p3p.plotView.writeAsPdfTo(path: "/Users/vincentherrmann/Documents/Projekte/Wavelets/db2WaveletF3.pdf")
